...
describe("store", () => {
    ...
    describe("getById", () => {
        it("Should return undefined when there is no data", async () => {
            const item = await getById(inventedId);
            expect(item).toBeUndefined();
        });
        it("Should return the correct item when it exists", async () => {
    ...
    describe("updateById", () => {
        it("Should return undefined whent there is no item with given id", async () => {
            const item = await updateById(inventedId);
            expect(item).toBeUndefined();
        });
        it("Should not return the item after update", async () => {
        ...
        it("Should update the item in the db", async () => {
            ...
            const item = await getById(updatedItem.id);
    ...
    describe("deleteById", () => {
        ...
        it("Should delete the item from the db", async () => {
            ...
            expect(item).toEqual(fixtures.filter((item) => item.id !== existingId));
        });
    });
});